...
$query = mysqli_query($conn, "
  ...
  WHERE p.status IN ('Dikembalikan', 'Menunggu Pengembalian')
...
<div class="main-content py-4">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="fw-semibold mb-1">Data Pengembalian</h5>
                <p class="text-muted mb-0">Riwayat dosir yang telah dikembalikan</p>
            </div>
        </div>
